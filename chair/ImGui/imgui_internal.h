...
//inline ImColor main_color = { 0.50f, 0.0f, 0.50f, 1.00f };
//inline ImColor main_color = { 0.90f, 0.45f, 0.07f, 1.00f };
inline ImColor main_color = { 0.37f, 0.37f, 0.37f, 1.00f };
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  ContentSize;                        // Size of contents/scrollable ClientNumber area (calculated from the extents reach of the cursor) from previous frame. Does not include window decoration or window padding.
    ImVec2                  ContentSizeIdeal;
    ImVec2                  ContentSizeExplicit;                // Size of contents/scrollable ClientNumber area explicitly request by the user via SetNextWindowContentSize().
    ImVec2                  WindowPadding;                      // Window padding at the time of Begin().
    float                   WindowRounding;                     // Window rounding at the time of Begin(). May be clamped lower to avoid rendering artifacts with title bar, menu bar etc.
    float                   WindowBorderSize;    
    float                   TitleBarHeightt, MenuBarHeightt;
...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonEx(const char* label, const char* description, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
